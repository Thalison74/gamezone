...
homeSwiper.on("transitionEnd", function (e) {
  ...
  if (this.activeIndex == 2) {
    root.style.setProperty(
      "--body-color",
      "linear-gradient(to right, #e74c3c, #A80B0B)"
      );
      root.style.setProperty("--sub", "#f0f0f0");
      root.style.setProperty("--title-color", "#ffffff");
      root.style.setProperty(
        "--container-color",
        "linear-gradient(136deg,  #e74c3c, #A80B0B)"
      );
  }
  if (this.activeIndex == 3) {
    root.style.setProperty(
      "--body-color",
      "linear-gradient(to right, #4CAF50, #001F3F)"
      );
      root.style.setProperty("--sub", "#FFA500");
      root.style.setProperty("--title-color", "#ffffff");
      root.style.setProperty(
        "--container-color",
        "linear-gradient(136deg, #4CAF50, #001F3F)"
      );
  }
  if (this.activeIndex == 4) {
    root.style.setProperty(
      "--body-color",
      "linear-gradient(to right, #4c4c7a, #1a1a2e)"
      );
      root.style.setProperty("--sub", "#ffffff");
      root.style.setProperty("--title-color", "#ffffff");
      root.style.setProperty(
        "--container-color",
        "linear-gradient(136deg, #4c4c7a, #1a1a2e)"
      );
  }
});
